...
export class UpdateProductComponent implements OnInit {
    ...
    if (this.isShowForm == false && this.checkUpdate == false) {
      this.productService.infoUpdate(this.id, "vi").subscribe(response => {
        ...
        this.selectedCategory = {
          "id": this.infoUpdateProductResponse.categoryId,
          "name": this.infoUpdateProductResponse.categoryName
        };
        this.selectedStatus = {
          "statusCode": this.infoUpdateProductResponse.statusCode,
          "statusName": this.infoUpdateProductResponse.statusName
        };
      })
  ...
  update() {
    this.updateProductRequest = {
      "productId": this.infoUpdateProductResponse.idProd,
