...
export class ManageProductComponent implements OnInit {
  ...
  confirmRemove(request: number) {
    ...
    this.messageService.add({
      ...
      sticky: true,
      severity: 'warn',
      summary: this.translateService.getvalue("layout.button.confirm.title.delete"),
      detail: this.translateService.getvalue("layout.button.confirm.content.delete")
    });
  }
  ...
  confirmLock(request: number) {
    ...
    this.messageService.add({
      ...
      sticky: true,
      severity: 'warn',
      summary: this.translateService.getvalue("layout.button.confirm.title.lock"),
      detail: this.translateService.getvalue("layout.button.confirm.content.delete")
    });
  }
  ...
  confirmUnlock(request: number) {
    ...
    this.messageService.add({
      ...
      sticky: true,
      severity: 'warn',
      summary: this.translateService.getvalue("layout.button.confirm.title.unlock"),
      detail: this.translateService.getvalue("layout.button.confirm.content.delete")
    });
  }
